...
namespace _03._Need_for_Speed_III
{
    class Program
    {
        ...
        private static void Drive(string brand, int distance, int fuel, List<Car> cars)
        {
        ...
        private static void Refuel(string brand, int fuel, List<Car> cars)
        {
            Car car = cars.First(c => c.Brand == brand);
        ...
        private static void Revert(string brand, int kilometers, List<Car> cars)
        {
            Car car = cars.First(c => c.Brand == brand);
